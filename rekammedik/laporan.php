...
$tgl=tgl_indo($r[tanggal]);
	...
	$tgl=tgl_indo($r[tanggal]);
	if ($jum==2){
      echo "<tr><td align=center><span class=style23>00$no</span></td>";
	} else {
	  echo "<tr><td align=center><span class=style23>000$no</span></td>";
	}
      echo "<td><span class=style23>$tgl</span></td>
